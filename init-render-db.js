...
const DATABASE_URL = process.env.DATABASE_URL || 'postgresql://dpis_db_user:Afc4Yf0FdLwHD00bOvmC2UfiIcodwU2N@dpg-d5e4roumcj7s73cnqra0-a/dpis_db';
  ...
  try {
    ...
    const statements = initSql
      ...
      .filter(s => {
        ...
        const withoutComments = s.replace(/\/\*[\s\S]*?\*\//g, '').trim();
